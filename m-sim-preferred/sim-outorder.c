...
//FIXME: Don't do this here, do this at cache creation time:
	...
	char latency_vals_file_path[120] = "/home/ghostrunner/m-sim-research/m-sim-preferred/simulation-results/latency_values.txt";
...
//								std::cerr << "Context(" << i << ") has reached its entry point" << std::endl;
	...
	for(;;)
	{
		...
		// NOTES(MSR): This one seems to be run the most often.
...
void smt_print_stats()
{
	...
	FILE* throughput_ipc_file_path = fopen("/home/ghostrunner/m-sim-research/m-sim-preferred/simulation-results/throughputipc.txt", "a");
